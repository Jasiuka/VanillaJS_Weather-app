export const makeWeatherDescriptionAndCreateBackground = (weatherCode) => {
  ...
  switch (weatherCode) {
    case 0:
      weather.background = `assets/clear-bg.mp4`;
    ...
    case 2:
    case 3:
      weather.background = `assets/cloudy-bg.mp4`;
      weather.description = "Sky is cloudy";
      break;
    case 51:
    case 56:
      weather.background = `assets/rain-bg.mp4`;
    ...
    case 77:
    case 85:
      weather.background = `assets/snow-bg.mp4`;
    ...
    case 96:
    case 99:
      weather.background = `assets/storm-bg.mp4`;
      weather.description = `Storm`;
      break;
    default:
      backgroundUrl = `assets/clear.mp4`;
  }
  return weather;
};
